...
CreateNewNEATChIP <- function(LocalPath2NEAT, LocalBasePath2Project, NewProjectName) {
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
#******************************************************************
#*                                                                *
#*                NEAT create new ChIPpip project                 *
#*                                                                *
#******************************************************************
#
# LocalPath2NEAT <- '~/NEAT/'
...
#
mycode <- paste("`cp -r ", LocalPath2NEAT, "/ChIPpip/scripts/NewChIPpipProject " , LocalBasePath2Project, "`", sep="")
system(mycode)
mycode <- paste("`mv ", LocalBasePath2Project, "NewChIPpipProject " , LocalBasePath2Project, NewProjectName, "`", sep="")
system(mycode)
