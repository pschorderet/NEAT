...
#*----------------------------------------------------------------*
#*                                                                *
#* The below peakcalling script runs MACS2 (broad peaks)          *
#*                                                                *
#*----------------------------------------------------------------*

cat("\n ----------------------------------------\n", sep="")
cat("\n Entered PeakCaller_MACS2_broad.R \n", sep="")
cat("\n ----------------------------------------\n\n", sep="")
...
cmd <- paste("`macs2 callpeak -t ", path2sample," -c ", path2input," -f BAM --broad -g ", genomeMACS, " -n ", path2currSampleFolder, mySample, " -p ", fdr, "`", sep="")
cat("\n cmd line: \t ", cmd, "\n\n", sep="")
system(cmd)
